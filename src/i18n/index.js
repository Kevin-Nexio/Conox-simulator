...
const ui = {
  de: {
    ...
    "remote.aria": "Remote-Sitzung",
    "remote.role": "Remote-Modus",
    "remote.role.full": "Normal",
    "remote.role.display": "iPad Display",
    "remote.role.controller": "iPhone Control",
    "remote.pin": "Sitzungs-PIN",
    "remote.link": "Link",
    "remote.newPin": "PIN",
    "remote.displayButton": "CONOX View",
    "remote.fullscreenButton": "Vollbild",
    "remote.exitDisplay": "Normalansicht",
    "remote.close": "Schliessen",
    "remote.linkTitle": "iPhone verbinden",
    "remote.linkCopy":
      "Diesen QR-Code mit dem zweiten Gerät scannen. Das iPhone öffnet den Controller direkt mit dem richtigen PIN.",
    "remote.qrAlt": "QR-Code für den iPhone-Controller",
    "remote.displayUrl": "iPad Display: {{url}}",
    "remote.status.off": "Remote aus",
    "remote.status.waiting": "Warte auf Gerät",
    "remote.status.connected": "{{count}} Gerät verbunden",
  ...
  fr: {
    ...
    "remote.aria": "Session distante",
    "remote.role": "Mode distant",
    "remote.role.full": "Normal",
    "remote.role.display": "iPad Display",
    "remote.role.controller": "iPhone Control",
    ...
    "remote.newPin": "PIN",
    "remote.displayButton": "CONOX View",
    "remote.fullscreenButton": "Plein écran",
    "remote.exitDisplay": "Vue normale",
    "remote.close": "Fermer",
    "remote.linkTitle": "Connecter l'iPhone",
    "remote.linkCopy":
      "Scanne ce QR code avec le deuxième appareil. L'iPhone ouvre directement le contrôleur avec le bon PIN.",
    "remote.qrAlt": "QR code pour le contrôleur iPhone",
    "remote.displayUrl": "iPad Display: {{url}}",
    "remote.status.off": "Remote off",
    "remote.status.waiting": "En attente",
    "remote.status.connected": "{{count}} appareil connecté",
  ...
  en: {
    ...
    "remote.aria": "Remote session",
    "remote.role": "Remote mode",
    "remote.role.full": "Normal",
    "remote.role.display": "iPad Display",
    "remote.role.controller": "iPhone Control",
    ...
    "remote.newPin": "PIN",
    "remote.displayButton": "CONOX View",
    "remote.fullscreenButton": "Full screen",
    "remote.exitDisplay": "Normal view",
    "remote.close": "Close",
    "remote.linkTitle": "Connect iPhone",
    "remote.linkCopy":
      "Scan this QR code with the second device. The iPhone opens the controller with the correct PIN.",
    "remote.qrAlt": "QR code for the iPhone controller",
    "remote.displayUrl": "iPad Display: {{url}}",
    "remote.status.off": "Remote off",
    "remote.status.waiting": "Waiting",
    "remote.status.connected": "{{count}} device connected",
